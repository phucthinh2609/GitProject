...
// PRACTICE
    ...
    function makePractice() {
        ...
        for (i=0; i<flashcardNames.length; i++) {
            ...
            document.getElementsByClassName(`flip-card-back`)[i].innerHTML = `<input id="valueCheck_${flashcardNames[i].id}" class='value-answer' type='text' value=''> <button onclick="checkAnswer(${flashcardNames[i].id})" class="btn-check_${flashcardNames[i].id}" style="margin-top: 20px;">Check</button>`;
